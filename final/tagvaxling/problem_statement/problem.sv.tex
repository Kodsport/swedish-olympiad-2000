...
På översta spåret (kallat inspåret) står ett tåg med $n$ vagnar, numrerade från 1 till $n$ med början från den främsta vagnen.
På det undre spåret (kallat utspåret) ser du samma vagnar i önskad ordning då tåget lämnar växlingsområdet.
...
\item Sista vagnen på stickspåret till sista på utspåret
\end{itemize}
...
\section*{Indata}
Den första raden i indatan innehåller heltalet $n$ ($1 \leq n \leq 100$),
antalet vagnar i tåget.

Nästa rad innehåller heltalen $g_1, g_2, \dots, g_n$ ($1 \leq g_i \leq n$),
den önskade ordningen på vagnarna.
Det är garanterat att alla $g_i$ är unika.
